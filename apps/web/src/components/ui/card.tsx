...
function Card({
  ...
  return (
    <div
      ...
      className={cn(
        `
          group/card flex flex-col gap-4 overflow-hidden rounded-none bg-card
          py-4 text-xs/relaxed text-card-foreground ring-1 ring-foreground/10
    ...
    <div
      ...
      className={cn(
        `
          ...
          items-start gap-1 rounded-none px-4
