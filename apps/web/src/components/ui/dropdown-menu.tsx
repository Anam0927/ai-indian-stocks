        ...
        <MenuPrimitive.Popup
          ...
          className={cn(
            `
              ...
              rounded-none bg-popover text-popover-foreground shadow-md ring-1
    ...
    <MenuPrimitive.Item
      ...
      className={cn(
        `
          ...
          gap-2 rounded-none px-2 py-2 text-xs outline-hidden select-none
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        `
          flex cursor-default items-center gap-2 rounded-none px-2 py-2 text-xs
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        `
          w-auto min-w-24 rounded-none bg-popover text-popover-foreground
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        `
          relative flex cursor-default items-center gap-2 rounded-none py-2 pr-8
          pl-2 text-xs outline-hidden select-none
          focus:bg-accent focus:text-accent-foreground
